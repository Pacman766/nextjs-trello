...
import { ArrowLeft, ArrowRightIcon, Filter, MoreHorizontal, Trello } from "lucide-react";
...
export default function Navbar({ boardTitle, onEditBoard, onFilterClick, filterCount = 0 }: Props) {
	...
	if (isBoardPage) {
		return (
			<header className="bg-white border-b sticky z-50">
				<div className="container mx-auto px-4 py-3 sm:py-4">
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-2 sm:space-x-4 min-w-0">
							...
							>
								<ArrowLeft className="h-4 w-4 sm:w-5" />
